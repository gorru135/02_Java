...
public class VariableExample2 {
	...
	public static void main(String[] args) {
		...
		// * 카멜 표기법
		// 연결되는 두단어 중 후속 단어의 첫 문자를 대문자로 표기
		...
		byte byteNumber = 127; // 128을 넣는 순간 에러 
	...
	// 자료형 변수명 = 리터럴; 
		...
		// 뒤에 L을 붙여줌으로서 long 자료형인것을 나타냄. 
		
		float floatNumber = 1.2345f; // 대문자 F 또는 소문자 f
		...
		// 1. 대소문자 구분, 길이제한 x
		int abcedfg123456789;
		int abcedfG123456789; // G 다름 
