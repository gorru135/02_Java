...
Scanner sc = new Scanner(System.in);
	...
	public void deepCopy() {
		...
		System.out.println("copy한 arr : "+ Arrays.toString(copyArr1));
		System.out.println("copy한 arr : "+ Arrays.toString(copyArr2));
		System.out.println("copy한 arr : "+ Arrays.toString(copyArr3));
	}
