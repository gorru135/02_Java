 ...
 * 
 * 	Controller - model, view간의 상호작용을 조정, 제어하는 역활의 담당 
...
public class People { // 국민(사람) 클래스 
	...
	//public double bitCoin; <= 공통점이 아니므로 제거(모두가 하지 않음.)
	// public : [접근제한자 ]
	// int : 자료형
	// age; : 변수명;
	...
	// name 변수의 값을 돌려 보내주는 간접 접근 기능[getter]
	...
	public void setName(String name) {
		...
		// **this : 현재 객체
		// 멤버변수 name에 매개변수 name을 대입시키는 역활을 함 
		this.name = name;
	}
