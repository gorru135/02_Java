...
public class MemberService {
	...
	public void displayMenu() {
		...
		do {
			...
			case 4 : 
				...
				break;
			case 0 : System.out.println( "프로그램 종료..."/*프로그램종료 기능 호출*/); break;
			default : System.out.println("잘못 입력하셨습니다! 메뉴에 있는 번호만 입력해주세요..");
			
			}
			
		} while(menuNum != 0); //meunNum 이 0이면 반복 종료 
		
	}
	

	// 회원 가입 기능
	public String signUp() {//return 값을 넣어줘야함 
		// 반환형
	...
	public int updateMember() {
		...
		if(inputPw.equals(loginMember.getMemberPw())) {
			// -> 비밀번호가 같을 경우, 로그인한 회원의 이름, 나이 정보를 입력받은 값으로 변경 후 1반환
