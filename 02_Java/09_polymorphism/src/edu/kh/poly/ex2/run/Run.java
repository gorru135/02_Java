...
import edu.kh.poly.ex2.model.service.AbbstractService;
import edu.kh.poly.ex2.model.service.Calculator;
import edu.kh.poly.ex2.model.service.HGDCalculator;
import edu.kh.poly.ex2.model.service.PSCCalculator;

public class Run {
	public static void main(String[] args) {
		
		//Calculator cal = new PSCCalculator();
		...
		// -> 이를 이용하여 중요한 메인코드에 수정을 최소화 할수 있다.
		// ex) Run에 작성된 합, 차, 곱, 몫을 출력하는 코드의 수정 없이
		//		객체 생성코드 한 줄만 수정하여 다르게 작성된 기능을 수행할 수 있다.
