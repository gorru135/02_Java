...
import edu.kh.collection.pack2.medel.vo.Person;
...
public class SetService {
	...
	public void method1() {
		...
		//Set<Srting> set = new LinkedHashSet<String>();
		...
		System.out.println(set.remove("이클립스"));
		System.out.println(set);
	...
	public void method3() {
		...
		// Hashcode(),equals() 오버라이딩 필수적으로 진행되어야한다!!!
		//***********************************************
	...
	public void method4() {
		...
		//Integer(객체, Wrapper class) <==> int(자료형)
