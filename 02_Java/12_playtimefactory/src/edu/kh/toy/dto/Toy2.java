...
public class Toy2 {
	...
	// set은 중복저장 시 기존 객체 삭제됨
	
	public Toy2() {}
	public Toy2(String name, int age, int price, String color, 
			String manufactureDate, Set<String> materials) {
		super();
		this.name = name;
		this.age = age;
		this.price = price;
	...
	public String getMaterialsAsString() {
		...
		// 마지막 쉼표와 공백 제거하기 
		if(sb.length() > 0) {
			sb.setLength(sb.length() -2);// 두칸 사라진다.
		}
